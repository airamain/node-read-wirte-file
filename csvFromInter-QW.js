...
.on("end", function () {
  ...
  //writableStream = fs.createWriteStream("./out/csv/interNuevo-Valores-QW_"+ args[2].substring(21,29) + ".csv");
  writableStream = fs.createWriteStream("e:\\inter\\Informes\\QW\\Valores_Para_QW_"+ args[2].substring(15,29) );
  ...
  medicionTypes[punto].tension === '33')) {
   ...
   csvStream.end();
 //console.log('congratulations, your CSV:  interNuevo-Valores-QW_'+ args[2].substring(21,29) + '.csv');
 console.log('congratulations, your CSV:  Valores_PARA_QW_'+ args[2].substring(15,29) + '.csv'); 
});
