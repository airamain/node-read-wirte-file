...
.on("end", function () {
  ...
  writableStream = fs.createWriteStream("e:\\inter\\Informes\\Datos\\ValoresInter_"+ args[2].substring(15,29) );
...
//console.log('congratulations, your CSV:  Valores_Para_PW'+ args[2].substring(21,29) + '.csv');   
 console.log('congratulations, your CSV:  Valores_PARA_INTER'+ args[2].substring(15,29) + '.csv'); 
});
