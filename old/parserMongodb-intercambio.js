...
medicionTypes = require('./types/tipoMedicion2.json');
fs = require("fs");
        ...
        MongoClient.connect("mongodb://localhost:27017/inter", function (err, db) {
            if (!err) {
                ...
                for (i = 0; i < arrayinter.length; i++) {
                    if(!medicionTypes[arrayinter[i][0]]){
                    ...
                    else if(medicionTypes[arrayinter[i][0]].utilidad === 'I'){
                        ...
                        //obj.tension = medicionTypes[arrayinter[i][0]].tension;
                ...
                var collection = db.collection('medicion-intercambio-'+ args[2].substring(21,29));                               
