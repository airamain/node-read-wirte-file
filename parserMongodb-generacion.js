        ...
        MongoClient.connect("mongodb://localhost:27017/inter", function (err, db) {
            if (!err) {
                ...
                for (i = 0; i < arrayinter.length; i++) {
                    ...
                    //Filtro para seleccionar solo Generacion
                    else if(medicionTypes[arrayinter[i][0]].utilidad === 'G'){
                ...
                var collection = db.collection('medicion-generacion-'+ args[2].substring(21,29));
