...
.on("end", function () {
 ...
 //var workbook = excelbuilder.createWorkbook('./out/xls', 'interNuevo-QW_' + args[2].substring(21,29) + '.xlsx');
 var workbook = excelbuilder.createWorkbook('e:\\inter\\Informes\\QW', 'interNuevo_QW_' + args[2].substring(15,23) + '.xlsx');
 
 // Create a new worksheet with 106 columns and 3732 rows 
 var sheet1 = workbook.createSheet('QW-' + args[2].substring(15,23), 106 , 3732);
...
for (var i = 0;  i < arrayinter.length ; i++) {
  ...
  else if(medicionTypes[punto].tipo === 'Q' && (medicionTypes[punto].utilidad === 'T' || 
  medicionTypes[punto].utilidad === 'G') &&  (medicionTypes[punto].tension === '13,2' ||
  medicionTypes[punto].tension === '33')) {
 ...
 console.log('congratulations, your workbook  interNuevo-QW_'+ args[2].substring(21,29) + '.xlsx');
