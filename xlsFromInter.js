...
//var workbook = excelbuilder.createWorkbook('./out/xls', 'interNuevo_' + args[2].substring(21,29) + '.xlsx');
 
 // Create a new worksheet with 106 columns and 3732 rows 
 //var sheet1 = workbook.createSheet('inter-' + args[2].substring(21,29), 106 , 3732);
 var workbook = excelbuilder.createWorkbook('e:\\inter\\Informes\\', 'interNuevo-' + args[2].substring(15,23) + '.xlsx');
...
for (var i = 0;  i < arrayinter.length ; i++) {
 ...
 console.log('congratulations, your workbook  interNuevo_'+ args[2].substring(21,29) + '.xlsx');
