...
.on("end", function () {
 ...
 var workbook = excelbuilder.createWorkbook('e:\\inter\\', 'INTER_' + args[2].substring(15,23) + '.xlsx');
 
 // Create a new worksheet with 106 columns and 3732 rows 
 var sheet1 = workbook.createSheet('Todo-' + args[2].substring(15,23), 106 , 3732);
...
for (var i = 0;  i < arrayinter.length ; i++) {
  ...
  else if( medicionTypes[punto].tension === '13,2' || medicionTypes[punto].tension === '132'
  || medicionTypes[punto].tension === '500' || medicionTypes[punto].tension === '0'
  || medicionTypes[punto].tension === '200' || medicionTypes[punto].tension === '66'
  || medicionTypes[punto].tension === '33'  || medicionTypes[punto].tension === '345') {
