...
.on("end", function () {
 ...
 var workbook = excelbuilder.createWorkbook('e:\\inter\\Informes\\Tension', 'Prueba_' + args[2].substring(15,23) + '.xlsx');
 
 // Create a new worksheet with 106 columns and 3732 rows 
 var sheet1 = workbook.createSheet('Tension-' + args[2].substring(15,23), 106 , 3732);
 var sheet2 = workbook.createSheet('PW-' + args[2].substring(15,23), 106 , 3732);
...
sheet2.set(1, 1, 'PUNTO' );
sheet2.set(2, 1, 'MEDICION');
sheet2.set(3, 1, 'TENSION');
sheet2.set(4, 1, 'ELEMENTO');
sheet2.set(5, 1, 'TIPO');
sheet2.set(6, 1, 'UTILIDAD');
sheet2.set(7, 1, 'ESTACION');
sheet2.set(8, 1, 'NOMBRE ESTACION');
sheet2.set(9, 1, 'PROVINCIA');
sheet2.set(10, 1, 'ZONA');
//periodos de tiempo cada 15 minutos
sheet2.set(11, 1, '0:00');
sheet2.set(12, 1, '0:15');
sheet2.set(13, 1, '0:30');
sheet2.set(14, 1, '0:45');
sheet2.set(15, 1, '1:00'); 
sheet2.set(16, 1, '1:15');
sheet2.set(17, 1, '1:30');
sheet2.set(18, 1, '1:45');
sheet2.set(19, 1, '2:00');
sheet2.set(20, 1, '2:15');
sheet2.set(21, 1, '2:30');
sheet2.set(22, 1, '2:45');
sheet2.set(23, 1, '3:00');
sheet2.set(24, 1, '3:15');
sheet2.set(25, 1, '3:30');
sheet2.set(26, 1, '3:45');
sheet2.set(27, 1, '4:00');
sheet2.set(28, 1, '4:15');
sheet2.set(29, 1, '4:30');
sheet2.set(30, 1, '4:45');
sheet2.set(31, 1, '5:00');
sheet2.set(32, 1, '5:15');
sheet2.set(33, 1, '5:30');
sheet2.set(34, 1, '5:45');
sheet2.set(35, 1, '6:00');
sheet2.set(36, 1, '6:15');
sheet2.set(37, 1, '6:30');
sheet2.set(38, 1, '6:45');
sheet2.set(39, 1, '7:00');
sheet2.set(40, 1, '7:15');
sheet2.set(41, 1, '7:30');
sheet2.set(42, 1, '7:45');
sheet2.set(43, 1, '8:00');
sheet2.set(44, 1, '8:15');
sheet2.set(45, 1, '8:30');
sheet2.set(46, 1, '8:45');
sheet2.set(47, 1, '9:00');
sheet2.set(48, 1, '9:15');
sheet2.set(49, 1, '9:30');
sheet2.set(50, 1, '9:45');
sheet2.set(51, 1, '10:00');
sheet2.set(52, 1, '10:15');
sheet1.set(53, 1, '10:30');
sheet2.set(54, 1, '10:45');
sheet2.set(55, 1, '11:00');
sheet2.set(56, 1, '11:15');
sheet2.set(57, 1, '11:30');
sheet2.set(58, 1, '11:45');
sheet2.set(59, 1, '12:00');
sheet2.set(60, 1, '12:15');
sheet2.set(61, 1, '12:30');
sheet2.set(62, 1, '12:45');
sheet2.set(63, 1, '13:00');
sheet2.set(64, 1, '13:15');
sheet2.set(65, 1, '13:30');
sheet2.set(66, 1, '13:45');
sheet2.set(67, 1, '14:00');
sheet2.set(68, 1, '14:15');
sheet2.set(69, 1, '14:30');
sheet2.set(70, 1, '14:45');
sheet2.set(71, 1, '15:00');
sheet2.set(72, 1, '15:15');
sheet2.set(73, 1, '15:30');
sheet2.set(74, 1, '15:45');
sheet2.set(75, 1, '16:00');
sheet2.set(76, 1, '16:15');
sheet2.set(77, 1, '16:30');
sheet2.set(78, 1, '16:45');
sheet2.set(79, 1, '17:00');
sheet2.set(80, 1, '17:15');
sheet2.set(81, 1, '17:30');
sheet2.set(82, 1, '17:45'); 
sheet2.set(83, 1, '18:00');
sheet2.set(84, 1, '18:15');
sheet2.set(85, 1, '18:30');
sheet2.set(86, 1, '18:45');
sheet2.set(87, 1, '19:00');
sheet2.set(88, 1, '19:15');
sheet2.set(89, 1, '19:30');
sheet2.set(90, 1, '19:45'); 
sheet2.set(91, 1, '20:00');
sheet2.set(92, 1, '20:15');
sheet2.set(93, 1, '20:30');
sheet2.set(94, 1, '20:45'); 
sheet2.set(95, 1, '21:00');
sheet2.set(96, 1, '21:15');
sheet2.set(97, 1, '21:30');
sheet2.set(98, 1, '21:45');
sheet2.set(99, 1, '22:00');
sheet2.set(100, 1, '22:15');
sheet2.set(101, 1, '22:30');
sheet2.set(102, 1, '22:45');
sheet2.set(103, 1, '23:00');
sheet2.set(104, 1, '23:15');
sheet2.set(105, 1, '23:30');
sheet2.set(106, 1, '23:45');
...
for (var i = 0;  i < arrayinter.length ; i++) {
    ...
    medicionTypes[punto].tension === '33') || medicionTypes[punto].punto === '102500' ) {
      ...
      // process.exit(1);
        ...
        //valores... que vienen del inter el cual esta actualizado al 01/09/2017  - se actualiza inter al 29-11-17
  ...
  else if( medicionTypes[punto].tipo === 'Tension' || medicionTypes[punto].elemento === 'Barra' ) {
 ...
 console.log('congratulations, your workbook  interNuevo-Tension_'+ args[2].substring(21,29) + '.xlsx');
